...
const SZOVEGEK = {
  hu: {
    ...
    bevezeto:
      ...
      'A válaszokat szabadon átírhatod. A „## [azonosító]” kezdetű címsorokat ne módosítsd, mert ezek alapján kerülnek a válaszok a Word-űrlap megfelelő helyére.',
    ...
    igenNem: (v) => `Az első sor: ${v.nem} vagy ${v.igen}. ${v.igen} esetén alatta írd le, hogyan előzi meg a testi és lelki kárt.`,
    valasztas: (l) => `Válassz: ${l.join(' / ')}.`,
    megerosites: 'Igen, ha felülvizsgáltad; ekkor az emlékeztető kikerül a dokumentumból.',
    hozzafuzes: 'Sorold fel, mely dokumentumokat csatolod; a válasz a sablon szövege alá kerül.',
