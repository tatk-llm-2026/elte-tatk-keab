...
- [ ] 9.7 Elkülönített futtató a másik asszisztenshez (Codex `codex exec`, Claude `claude -p`), hogy csak a bírálati csomagot lássa; amíg nincs, a `KULSO_FUTTATO_VAN` hamis, a program nem kér rá engedélyt, és a saját asszisztens bírál (subagent vagy új beszélgetés); ellenőrzés: a „Másik asszisztens bírál" forgatókönyv a mintaprojekten
